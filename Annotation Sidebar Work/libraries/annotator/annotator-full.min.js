...
function() {
	...
	Annotator = function(_super) {
		...
		Annotator.prototype.highlightRange = function(normedRange, cssClass) {
			...
			white = /^\s*$/;
// Amanda: create highlighted text as <a> link. Might want to remove <a> eventually?
			hl = $("<a class='" + cssClass + "' href=''></a>");
	...
	Annotator.Viewer = function(_super) {
		...
		Viewer.prototype.load = function(annotations) {
			...
			for(var key in annotations){
  				woo = annotations[key]['nid'];
  				theresult.push(woo);
			}
			grabNID = theresult.join(',');
			console.log(grabNID);
			$('#edit-nid--2').val(grabNID);
			$('#views-exposed-form-annosidebar-annosidebar').submit();// autosubmit
			//console.log(Object.keys(annotations));
			//get nested javascript property firebug
			//console.log(typeof annotations); //it's an object!.. which in JS can mean absolutely anything including a function. bleh.
			//whatever = annotations.filter(function(obj){
				//hey = obj.nid;
				//console.info(hey); //individual nids again, separate lines; .join() not allowed for some reason
			//});
			//console.log(this.annotations);//Amanda: [Object nid etc] [Object vid etc] same line
			//console.log(annotations.join());//Amanda: [object Object],[object Object] same line w/o nid
			//annotations.join(); makes a string; so, either get nids first and .join() those, or figure out way to cut the string down to the nids only
			list = this.element.find("ul:first").empty();
			_ref2 = this.annotations;
			//console.log(_ref2);//Amanda: [two Objects]
			for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
				annotation = _ref2[_k];
...
//Amanda: below is active work area
//Strip URL to just the NID(s)
				//grabNID = links[0].href.replace( '/www.infiniteulysses.com/node/', '');
				//$('#edit-nid--2').val(grabNID);
				//$('#views-exposed-form-annosidebar-annosidebar').submit(); //autosubmit
// Amanda: end active work area
				_ref3 = this.fields;
