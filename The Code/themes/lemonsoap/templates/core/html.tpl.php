...
<!-- printing the mini panel -->
<?php
$block = module_invoke('panels_mini', 'block_view', 'headerminipanel');
print $block['content'];
?>

<!-- printing the beta ribbon -->
<div class="ribbonwrapper">
<a href="http://www.InfiniteUlysses.com/content/research-statement"><div class="ribbon-wrapper"><div class="ribbon-inner">Beta Mode!</div></div></a>
</div>
